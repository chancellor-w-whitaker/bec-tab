        ...
        <div className="d-flex flex-column gap-5">
          ...
          <div className="d-flex flex-row flex-wrap gap-3">
            <div className="d-flex flex-column gap-3 col">
              <CoolTitle className="text-nowrap">Financial Aid</CoolTitle>
              <SecondaryContent
            ...
            <div className="d-flex flex-column gap-3 col">
              <CoolTitle className="text-nowrap">Student Accounting</CoolTitle>
              <SecondaryContent
                contentClassName="flex-column"
                className="h-100"
                title=""
            ...
            <div className="d-flex flex-column gap-3 col">
              <CoolTitle className="text-nowrap">Registrar</CoolTitle>
              <SecondaryContent
                contentClassName="flex-column"
                className="h-100"
                title=""
...
const CoolTitle = ({ children = "Placeholder", className = "" }) => {
  return (
    <>
      <div className={`fs-2 eku-text-shadow lh-sm text-center ${className}`}>
        {children}
      </div>
    </>
  );
...
const SecondaryContent = ({
  ...
  return (
    ...
    >
      {!hideTitle && <CoolTitle>{title}</CoolTitle>}
      <div className={`d-flex flex-wrap gap-2 ${contentClassName}`.trimEnd()}>
        {children}
      </div>
    </div>
  );
