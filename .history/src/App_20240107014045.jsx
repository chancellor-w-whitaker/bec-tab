...
const Card = () => {
  return (
    <>
      <div className="p-2 rounded text-bg-dark" style={{ width: 250 }}>
        Flex item 3
      </div>
    </>
  );
          ...
          <div className="d-flex flex-column gap-4">
            ...
            <div className="text-bg-light">
              <div className="d-flex flex-row justify-content-around">
                <div className="p-2 rounded text-bg-dark">Flex item 1</div>
                <div className="p-2 rounded text-bg-dark">Flex item 2</div>
                <div className="p-2 rounded text-bg-dark">Flex item 3</div>
              </div>
            </div>
            <div className="text-bg-light">Chance</div>
          </div>
