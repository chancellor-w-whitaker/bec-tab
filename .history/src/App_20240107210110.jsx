    ...
    <>
      <div className="d-flex flex-row gap-3 flex-wrap">
        <div className="d-flex flex-column gap-2 text-center col">
          ...
          >
            <div className="rounded p-2 border d-flex flex-column gap-2">
              <div className="text-secondary fw-medium fs-5 lh-sm">Chance</div>
              <div>
                <div>One</div>
                <div>Two</div>
                <div>Three</div>
            ...
            <div className="rounded p-2 border d-flex flex-column gap-2">
              <div className="text-secondary fw-medium fs-5 lh-sm">Chance</div>
              <div>
                <div>One One One One One</div>
                <div>Two</div>
                <div>Three</div>
              </div>
            </div>
            <div className="rounded p-2 border d-flex flex-column gap-1">
              <div className="text-secondary fw-medium fs-5 lh-sm">Chance</div>
              <div>
                <div>One</div>
                <div>Two</div>
