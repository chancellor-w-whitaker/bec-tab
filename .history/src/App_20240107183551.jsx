...
const SomeBlock = ({
  ...
  return (
    <div className="border rounded p-2 d-flex flex-column gap-1 flex-fill">
          ...
          <div className="rounded border text-center p-3 d-flex flex-column gap-3">
            ...
            <div className="d-flex gap-3">
              <SomeBlock
                ...
                paragraph={"(1/7/2024)"}
              ></SomeBlock>
              <SomeBlock paragraph={"(1/7/2024)"} title={"Call"}></SomeBlock>
              <SomeBlock paragraph={"(1/7/2024)"} title={"Walk-In"}></SomeBlock>
              <SomeBlock paragraph={"(1/7/2024)"} title={"Email"}></SomeBlock>
            </div>
          </div>
