    ...
    <div className="container-fluid">
      <div className="row">
        <div className="sidebar border border-right col-md-3 col-lg-2 p-0 bg-warning-subtle">
          ...
          >
            <a
              className="d-flex align-items-center mb-3 me-md-auto link-body-emphasis text-decoration-none"
              href="/"
            >
              <span className="fs-4">Sidebar</span>
            </a>
            <ul className="nav nav-pills flex-column mb-auto gap-2 text-center">
