      ...
      <div className="row">
        <div className="sidebar col-md-3 col-lg-2 p-3 bg-white">
          <div className="d-flex flex-column text-center">
            <div className="fs-5 mb-2 lh-sm">Impersonation Links</div>
            <ul className="nav nav-pills flex-column gap-2">
              <NavItem href="https://www.eku.edu/">Service Ticket</NavItem>
          ...
          <hr></hr>
          <div className="d-flex flex-column text-center">
            <div className="fs-5 mb-2 lh-sm">Banner Links</div>
            <ul className="nav nav-pills flex-column gap-2">
              <NavItem
