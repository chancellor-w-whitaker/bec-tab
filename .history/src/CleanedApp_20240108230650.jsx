    ...
    <>
      <div className="col-md-9 col-xl-10 ms-sm-auto px-md-4 py-3 bg-success-subtle">
        <div className="d-flex flex-column gap-5">
          ...
          <SecondaryContent className="children-w-275px justify-content-evenly">
            <TertiaryContent>
              <div>Chance</div>
              <div>Chance</div>
            </TertiaryContent>
          ...
          <div className="d-flex flex-row flex-wrap gap-3">
            <SecondaryContent className="flex-fill"></SecondaryContent>
            <SecondaryContent className="flex-fill"></SecondaryContent>
            <SecondaryContent className="flex-fill"></SecondaryContent>
          </div>
        </div>
...
const SecondaryContent = ({
  ...
  return (
    ...
    >
      ...
      <div className={`d-flex flex-row flex-wrap gap-2 ${className}`.trimEnd()}>
        {children}
      </div>
    </div>
  );
