...
const SomeBlock = ({ paragraph, title }) => {
  return (
    <div className="border rounded p-2 d-flex flex-column gap-1 w-100">
      <div className="fs-5">Chancellor</div>
      <p className="mb-0">{genericSentences.slice(0, 1).map((sen) => sen)}</p>
    </div>
  );
};
      ...
      <div className="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-3 bg-white">
        <div className="d-flex flex-column gap-5">
          ...
          <div className="rounded border text-center p-3 d-flex flex-column gap-3">
            <div className="fs-3 lh-1">Chance</div>
            <div className="d-flex gap-3">
              <div className="border rounded p-2 d-flex flex-column gap-1 w-100">
                <div className="fs-5">Chancellor</div>
                <p className="mb-0">
                  {genericSentences.slice(0, 1).map((sen) => sen)}
                </p>
              </div>
