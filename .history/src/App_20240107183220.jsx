        ...
        <div className="d-flex flex-column gap-5">
          ...
          <div className="rounded border text-center p-3 d-flex flex-column gap-3">
            ...
            <div className="d-flex gap-3">
              <SomeBlock
                paragraph={"Service Ticket"}
                title={"Date:"}
              ></SomeBlock>
              <SomeBlock paragraph={"Call"} title={"Date:"}></SomeBlock>
              <SomeBlock paragraph={"Walk-In"} title={"Date:"}></SomeBlock>
              <SomeBlock paragraph={"Email"} title={"Date:"}></SomeBlock>
            </div>
          </div>
