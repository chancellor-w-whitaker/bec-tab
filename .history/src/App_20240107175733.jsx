    ...
    <>
      <div className="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-3 bg-white">
        <div className="d-flex flex-column gap-5">
          ...
          <div className="p-2 bg-warning-subtle d-flex flex-column gap-2 text-center">
            <div className="fs-5 text-secondary fw-semibold">Chance</div>
            <div className="p-2 shadow-sm rounded bg-white">
              <div>Chance</div>
              <div>Chance</div>
            </div>
          </div>
