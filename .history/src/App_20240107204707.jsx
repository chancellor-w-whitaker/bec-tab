...
const Sidebar = () => {
  return (
    <>
      <div className="sidebar-lg-sticky col-md-3 col-lg-2 p-3 bg-white overflow-auto flex-shrink-0">
...
const Main = () => {
  return (
    <>
      <div className="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-3 bg-white flex-shrink-1">
